...
public class healthAdapter extends RecyclerView.Adapter<healthAdapter.ViewHolder> {
    ...
    private List<health_model> itemList = new ArrayList<health_model>();
    private Context context;
    private int lastPosition = -1;


    public healthAdapter(List<health_model> itemList, Context context) {
    ...
    public healthAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_view_health, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        final health_model event = itemList.get(position);
