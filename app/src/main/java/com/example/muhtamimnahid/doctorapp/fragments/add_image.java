package com.example.muhtamimnahid.doctorapp.fragments;
...
import com.example.muhtamimnahid.doctorapp.sample.MainActivitytrack;
...
import com.example.muhtamimnahid.doctorapp.helper.Activity_Editor;
import com.example.muhtamimnahid.doctorapp.helper.helper_main;
import com.example.muhtamimnahid.doctorapp.helper.helper_pdf;
        ...
        fab_2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(imgFile.exists()){
                    ...
                    Intent intent = new Intent(getActivity(), MainActivitytrack.class);
