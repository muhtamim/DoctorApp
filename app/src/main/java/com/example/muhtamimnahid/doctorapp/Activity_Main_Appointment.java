...
public class Activity_Main_Appointment extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Doctor's Appointment");

        //DrawerLayout and ToggleButton
        mDrawerLayout = findViewById(R.id.main_drawerLayout);
        mToggle = new ActionBarDrawerToggle(Activity_Main_Appointment.this,mDrawerLayout,R.string.open,R.string.close);
    ...
    private void chechType() {
        ...
        mUserDatabase.child("User_Type").child(uid).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(Activity_Main_Appointment.this, status+" -"+Type, Toast.LENGTH_SHORT).show();

                   if(Type.equals("Doctor")&& status.equals("Approved") ){
               ...
               Toast.makeText(Activity_Main_Appointment.this, status+" -"+Type, Toast.LENGTH_SHORT).show();
                    ...
                    mUserDatabase.child("DoctorList").child(uid).addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            Toast.makeText(Activity_Main_Appointment.this, "Your Are Logged In", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Activity_Main_Appointment.this, "You are not authorized for this facility or Account Under Pending", Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(Activity_Main_Appointment.this,databaseError.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.nav_profile:
                ...
                Intent profile_Intent = new Intent(Activity_Main_Appointment.this,Doctor_ProfileActivity.class);
...
//                Toast.makeText(getBaseContext(),"Show Appointment Clicked",Toast.LENGTH_LONG).show();
                Intent showAppointment_Intent = new Intent(Activity_Main_Appointment.this,Doctor_ShowAppointmentActivity.class);
...
//                Toast.makeText(getBaseContext(),"Booked Appointment Clicked",Toast.LENGTH_LONG).show();
                Intent bookedAppointment_Intent = new Intent(Activity_Main_Appointment.this,Patient_ShowBookedAppointmentActivity.class);
                startActivity(bookedAppointment_Intent);
                break;

            case R.id.nav_login:
                Intent login_Intent = new Intent(Activity_Main_Appointment.this, LoginActivity.class);
...
//                Toast.makeText(getBaseContext(),"Feedback Clicked",Toast.LENGTH_LONG).show();
                startActivity(new Intent(Activity_Main_Appointment.this,FeedbackActivity.class));
                break;

//            case R.id.nav_aboutapp:
////                Toast.makeText(getBaseContext(),"About Us Clicked",Toast.LENGTH_LONG).show();
//                startActivity(new Intent(Activity_Main_Appointment.this,About_App.class));
//                break;
