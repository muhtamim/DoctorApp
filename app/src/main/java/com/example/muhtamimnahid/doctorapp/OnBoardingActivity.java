...
public class OnBoardingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_get_started.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                savePrefsData();
                finish();
                Toast.makeText(OnBoardingActivity.this,"Thank You for Downloading CareConnect",Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void loadData()
    {
        ...
        int[] imageId = {R.drawable.onboard_page1, R.drawable.onboard_page3, R.drawable.onboard_page2,R.drawable.onboard_page4, R.drawable.onboard_page5};
