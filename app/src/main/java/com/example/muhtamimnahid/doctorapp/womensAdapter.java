...
public class womensAdapter extends RecyclerView.Adapter<womensAdapter.ViewHolder> {

    private List<womens_model> itemList = new ArrayList<womens_model>();
    private Context context;
    private int lastPosition = -1;


    public womensAdapter(List<womens_model> itemList, Context context) {
        this.itemList = itemList;
        this.context = context;
    }

    @Override
    public womensAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_view_womens, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        final womens_model event = itemList.get(position);
