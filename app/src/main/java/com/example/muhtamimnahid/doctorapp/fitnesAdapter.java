...
public class fitnesAdapter extends RecyclerView.Adapter<fitnesAdapter.ViewHolder> {

    private List<Fitnes_model> itemList = new ArrayList<Fitnes_model>();
    private Context context;
    private int lastPosition = -1;


    public fitnesAdapter(List<Fitnes_model> itemList, Context context) {
        this.itemList = itemList;
        this.context = context;
    }

    @Override
    public fitnesAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_view_fitnes, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        final Fitnes_model event = itemList.get(position);
